...
public class DriveConstants {
    ...
    public static double GEAR_RATIO = 1.0 * (65.5 / 65.3675); // output (wheel) speed / input (motor) speed
     ...
     * inches.
     */
    public static double MAX_VEL = 61.68 * 0.80;
    public static double MAX_ACCEL = 61.68 * 0.80;
